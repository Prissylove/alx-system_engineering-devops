...
File 8-true_knowledge is a script that prints the result of the addition of 128 with the value stored in the
environment variable TRUEKNOWLEDGE, followed by a new line.

File 9-divide_and_rule is a script that prints the result of POWER divided by DIVIDE, followed by a 
new line.
...
File 103-water_and_stir is a shell script that adds the two numbers stored in the environment variables 
